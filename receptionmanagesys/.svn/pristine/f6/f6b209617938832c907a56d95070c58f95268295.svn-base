...
<script>
	 ...
	 function doSearch() {
		 ...
		 opts.url = "/TaskQueryServlet?method=queryExceedBillTypeTask";
		 $('#tt').datagrid('load', {
			date : $('#datetime1').val(),
		}); 
	}
...
<body>
	<table id="tt" class="easyui-datagrid"
		...
		toolbar="#tb" title="费用类型超出查询" iconCls="icon-save" rownumbers="true"
		pagination="true">
		<thead>
			<tr>
				...
				<th field="otherBill" width="120" align="center">其他类型费用</th>
